...
# 26 "cohttp/src/accept_parser.ml"
let yytransl_const = [|
  257 (* STAR *);
  258 (* SLASH *);
  259 (* SEMI *);
...
# 43 "cohttp/src/accept_parser.mly"
                    ( Kv (_2, S _4) )
# 127 "cohttp/src/accept_parser.ml"
               : 'param))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 2 : string) in
    let _4 = (Parsing.peek_val __caml_parser_env 0 : string) in
...
# 139 "cohttp/src/accept_parser.ml"
               : 'param))
; (fun __caml_parser_env ->
...
# 52 "cohttp/src/accept_parser.mly"
  ( [] )
# 153 "cohttp/src/accept_parser.ml"
               : 'params))
; (fun __caml_parser_env ->
...
# 162 "cohttp/src/accept_parser.ml"
               : 'media_range))
; (fun __caml_parser_env ->
...
# 172 "cohttp/src/accept_parser.ml"
               : 'media_range))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 3 : string) in
...
# 183 "cohttp/src/accept_parser.ml"
               : 'media_range))
; (fun __caml_parser_env ->
...
# 66 "cohttp/src/accept_parser.mly"
                  ( [_1] )
# 190 "cohttp/src/accept_parser.ml"
...
# 68 "cohttp/src/accept_parser.mly"
      ( [] )
# 204 "cohttp/src/accept_parser.ml"
               : (Accept_types.media_range * Accept_types.p list) Accept_types.qlist))
; (fun __caml_parser_env ->
...
# 72 "cohttp/src/accept_parser.mly"
              ( (get_q _2, AnyCharset) )
# 219 "cohttp/src/accept_parser.ml"
               : 'charset))
; (fun __caml_parser_env ->
...
# 75 "cohttp/src/accept_parser.mly"
              ( [_1] )
# 226 "cohttp/src/accept_parser.ml"
...
# 250 "cohttp/src/accept_parser.ml"
               : 'encoding))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'params) in
    Obj.repr(
...
# 257 "cohttp/src/accept_parser.ml"
               : 'encoding))
; (fun __caml_parser_env ->
...
# 91 "cohttp/src/accept_parser.mly"
               ( [_1] )
# 264 "cohttp/src/accept_parser.ml"
...
# 93 "cohttp/src/accept_parser.mly"
      ( [] )
# 278 "cohttp/src/accept_parser.ml"
               : Accept_types.encoding Accept_types.qlist))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : string) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'params) in
...
# 288 "cohttp/src/accept_parser.ml"
               : 'language))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'params) in
    Obj.repr(
...
# 295 "cohttp/src/accept_parser.ml"
               : 'language))
; (fun __caml_parser_env ->
...
# 102 "cohttp/src/accept_parser.mly"
               ( [_1] )
# 302 "cohttp/src/accept_parser.ml"
